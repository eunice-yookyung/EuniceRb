Public Function AddMottInsulatorSequenceWithBlackCoilAsVariableAndLattGravOff(ByVal t_start As Double, _
    ...
    If MI_en = True Then
        ...
        'analogdata.AddStep(ps6_scaler*quic_gravity_offset, axial_start_time, twodmax_ready_time, ps6_ao)
