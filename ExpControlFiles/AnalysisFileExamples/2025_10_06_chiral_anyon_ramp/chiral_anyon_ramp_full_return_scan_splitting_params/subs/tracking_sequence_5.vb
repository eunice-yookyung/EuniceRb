Public Function AddTrackingSequence5(ByVal t_start As Double, _
	...
	Dim flip_time As Double = 0
	Dim IT As Double = flip_time + guppy_wait + t_start
	Dim last_time = IT + 3 * guppy_interval + 2000
	Dim pulse_start_padding As Double = 500 'shutter_time + 1 '1 ms padding to turn on lattices before rising edge of camera pulse to prevent timing jitter from affecting the images
