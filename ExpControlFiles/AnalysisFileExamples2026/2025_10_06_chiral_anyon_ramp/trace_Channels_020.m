...
path_files = 'chiral_anyon_ramp_020\'; % Don't forget to add \ at the end!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
name_sequence = 'chiral_anyon_ramp_020.vb';
batch_line = 8;
plot_sth_happens = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
channel_list = {'lattice2d765_power', 'lattice2d765_power2', ...
    'hor_dmd_power', 'hor_dmd_trigger', 'line_dmd_power', ...
    'ps6_ao', 'ps5_ao', 'ps1_ao'}; 
% channel_list = {'ps6_ao', 'ps5_ao', 'ps1_ao', 'lattice2d765_power2','hor_dmd_power','hor_dmd_trigger', 'line_dmd_power' };
set_lin = 1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
