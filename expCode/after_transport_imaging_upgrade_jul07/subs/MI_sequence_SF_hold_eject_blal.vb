Public Function AddMottInsulatorSequenceSFHoldEjBLAL(ByVal t_start As Double, _
    ByVal isBigLatt As Double, _
...
Dim big_latt_end_volt As Double = 0
Dim axial_latt_end_volt As Double = 0
...
digitaldata2.AddPulse(big_lattice_ttl, cigar_move_end_time-1, twodmax_ready_time)
digitaldata2.AddPulse(big_lattice_shutter, cigar_move_end_time-40, twodmax_ready_time)

analogdata.AddStep(biglattice_maxPower, axial_ready_time,twodmax_ready_time, big_lattice_power)
'analogdata.AddSmoothRamp(biglattice_maxPower,1.9, axial_ready_time, dipole_start_time, big_lattice_power)
big_latt_end_volt = biglattice_maxPower
axial_latt_end_volt = 1.76
...
big_latt_end_volt = 1.9
axial_latt_end_volt = axial_voltage
...
End If
    ...
    Return {t_stop, lattice1_max_volt, lattice2_max_volt, _
    end_dipole_voltage,big_latt_end_volt,axial_latt_end_volt}
End Function
