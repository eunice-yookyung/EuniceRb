Public Function AddPinningSequenceWithImagingAsVar(ByVal t_start As Double,
    ...
    ByVal pinning_en As Boolean) As Double()
    ...
    Dim molasses_start_time As Double = pinning_ready_time + pinning_ramp_up
    ...
    If pinning_en = True Then
        ...
        analogdata.AddExp(pinning_axial_volt, pinning_axial_volt, pinning_start_time, pinning_ready_time, pinning_time_const, axial795_power)
        analogdata.AddExp(pinning_2D1_volt, pinning_2D1_volt, pinning_start_time, pinning_ready_time, pinning_time_const, lattice2D795_power)
        analogdata.AddExp(pinning_2D2_volt, pinning_2D2_volt, pinning_start_time, pinning_ready_time, pinning_time_const, lattice2D795_power2)

        analogdata.AddStep(pinning_axial_volt, pinning_ready_time, pinning_end_time, axial795_power)
        analogdata.AddStep(pinning_2D1_volt, pinning_ready_time, pinning_end_time, lattice2D795_power)
        analogdata.AddStep(pinning_2D2_volt, pinning_ready_time, pinning_end_time, lattice2D795_power2)
        '********************************************************** End Pinning Lattice ***********************************************************
        ...
        analogdata2.AddStep(quic_molasses_voltage_dim_pin, molasses_start_time, pinning_end_time, quic_molasses_power)
        ...
        digitaldata2.AddPulse(molasses_shaker, molasses_start_time - 30, pinning_end_time + 100) ' molasses shaker on quic retro-reflect mirror
