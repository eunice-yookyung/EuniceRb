Public Function AddAbsorptionImagingSequenceSelect12Repump(ByVal t_start As Double,
    ...
    ByVal absorption_en As Boolean,
    ByVal if_repump12 As Double) As Double
