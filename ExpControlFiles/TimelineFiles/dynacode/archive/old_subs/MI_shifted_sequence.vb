Public Function AddMottInsulatorShiftedSequence(ByVal t_start As Double, _
...
analogdata.AddSmoothRamp(0,dipole_displace_quad,bfield_off_time,axial_start_time,ps1_ao)'pre-compensate lattice gradient 
analogdata.AddStep(dipole_displace_quad,axial_start_time,twod_start_time,ps1_ao)
analogdata.AddExpSane(dipole_displace_quad, quad_gravity_offset,54, twod_start_time, twodmax_ready_time, ps1_ao)'gravity offset in deep lattice
...
analogdata.AddSmoothRamp(0 + ps6_offset, ps6_scaler*dipole_displace_quic + ps6_offset,bfield_off_time,axial_start_time,ps6_ao)'pre-compensate lattice gradient 
analogdata.AddStep(ps6_scaler*dipole_displace_quic + ps6_offset,axial_start_time,twod_start_time,ps6_ao)
analogdata.AddExpSane(ps6_scaler*dipole_displace_quic + ps6_offset, ps6_scaler*quic_gravity_offset + ps6_offset, 54, twod_start_time, twodmax_ready_time, ps6_ao)'gravity offset in deep lattice
