Public Function AddPinningSequenceUpgrade(ByVal t_start As Double, _
...
digitaldata.AddPulse(mot_low_current, pinning_start_time, pinning_end_time) 'MOT Current Supply
digitaldata.AddPulse(ta_shutter, pinning_start_time, pinning_end_time) 'TA Shutter. starts to close early, so the shutter is closed ASAP after the blow away pulse.
digitaldata.AddPulse(repump_shutter, pinning_start_time, pinning_end_time) 'Repump Shutter
'======================================
