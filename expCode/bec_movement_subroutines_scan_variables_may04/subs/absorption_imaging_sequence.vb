Public Function AddAbsorptionImagingSequence(ByVal t_start As Double, _
    ...
    Dim t_optical_pumping As Double = 0.3 '0.3
...
digitaldata.AddPulse(repump_shutter, t_start-35, t_start) 'shutter closed delayed 
digitaldata.AddPulse(polarizer_shutter_22, t_start-20, t_start) 'imaging Shutter from side

digitaldata.AddPulse(ttl_78MHz, t_start-40, t_start-t_optical_pumping) 'ttl_78MHz on means repump is off for imaging (it all went to MOT)
digitaldata.AddPulse(ttl_78MHz, t_start, t_start + 10 )
'digitaldata.AddPulse(ttl_78MHz, t_start-100, t_start-.3 )
'digitaldata.AddPulse(ttl_78MHz, t_start, t_start + 10) ' pump atoms from 1 to 2

'digitaldata.AddPulse(ttl_78MHz, t_start-40, t_start + 10) ' 2022/07/22, test to remove repump
