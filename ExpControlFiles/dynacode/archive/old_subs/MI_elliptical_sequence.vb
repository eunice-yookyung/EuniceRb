Public Function AddEllipticalMottInsulatorSequence(ByVal t_start As Double, _
...
'*********************************************************************************************************************************************************
Dim line_DMD_wall_volt As Double = 3.1
Dim hor_DMD_wall_volt As Double = 2.9
...
Dim dipole_start_time As Double = axial_ready_time 'walls_rampon_end_time	
...
Dim walls_rampon_start_time As Double = dipole_start_time 'axial_ready_time
Dim walls_rampon_end_time As Double = dipole_ready_time'walls_rampon_start_time + 10
Dim DMD_rampdown_start_time As Double = twodmax_ready_time
Dim DMD_rampdown_end_time As Double = DMD_rampdown_start_time + 20'10
...
digitaldata.AddPulse(offset_fet, t_start, DMD_rampdown_end_time) 'Offset FET
digitaldata.AddPulse(bias_enable, t_start, DMD_rampdown_end_time) 'Enables bias coils
digitaldata.AddPulse(transport_13, t_start, DMD_rampdown_end_time) 'Keeps T13 on through remainder of experiment
digitaldata.AddPulse(ps5_enable, t_start, DMD_rampdown_end_time)
digitaldata2.AddPulse(ioffe_mirror_fet, t_start, DMD_rampdown_end_time)
digitaldata.AddPulse(quad_shim, t_start, DMD_rampdown_end_time)
digitaldata2.AddPulse(single_quad_shim, bfield_off_time, DMD_rampdown_end_time)
digitaldata.AddPulse(ps4_shunt, t_start, DMD_rampdown_end_time)
digitaldata.AddPulse(imaging_coil, t_start, DMD_rampdown_end_time)
...
'****************************************Axial lattice***********************************************
digitaldata.AddPulse(ttl_axial_lattice, axial_start_time-1,DMD_rampdown_end_time)
digitaldata.AddPulse(axial_lattice_shutter, axial_start_time-50, DMD_rampdown_end_time)
...
analogdata.AddStep(axial_voltage,twod_start_time,DMD_rampdown_end_time,axial_lattice_power)
...
If red_freq > 0 Then
    digitaldata2.AddPulse(anticonfin_ttl, dipole_start_time-1,DMD_rampdown_end_time)
    digitaldata2.AddPulse(anticonfin_shutter, dipole_start_time-20, DMD_rampdown_end_time)
End If

analogdata.AddSmoothRamp(1.44, dipole_voltage, dipole_start_time, dipole_ready_time, red_dipole_power)
analogdata.AddStep(dipole_voltage,dipole_ready_time, twod_start_time, red_dipole_power) 'calibration
...
analogdata.AddStep(end_dipole_voltage,twodmax_ready_time,DMD_rampdown_end_time, red_dipole_power)

'**********************************************DMD******************************************
digitaldata2.AddPulse(line_DMD_trigger, walls_rampon_start_time-10, walls_rampon_start_time)
digitaldata2.AddPulse(hor_DMD_trigger, walls_rampon_start_time-10, walls_rampon_start_time)

digitaldata2.AddPulse(line_DMD_shutter, walls_rampon_start_time - 20, twodmax_ready_time)
digitaldata2.AddPulse(line_DMD_ttl, walls_rampon_start_time - 1, twodmax_ready_time)

digitaldata2.AddPulse(hor_DMD_shutter, walls_rampon_start_time - 20, DMD_rampdown_end_time)
digitaldata2.AddPulse(hor_DMD_ttl, walls_rampon_start_time - 1, DMD_rampdown_end_time)

analogdata2.AddSmoothRamp(line_DMD_start_volt, line_DMD_wall_volt, walls_rampon_start_time, walls_rampon_end_time, line_DMD_power)
analogdata2.AddStep(line_DMD_wall_volt, walls_rampon_end_time, DMD_rampdown_start_time, line_DMD_power)
analogdata2.AddSmoothRamp(line_DMD_wall_volt, line_DMD_start_volt, DMD_rampdown_start_time, DMD_rampdown_end_time, line_DMD_power)

analogdata2.AddSmoothRamp(hor_DMD_start_volt, hor_DMD_wall_volt, walls_rampon_start_time, walls_rampon_end_time, hor_DMD_power)
analogdata2.AddStep(hor_DMD_wall_volt, walls_rampon_end_time, DMD_rampdown_start_time, hor_DMD_power)
analogdata2.AddSmoothRamp(hor_DMD_wall_volt, hor_DMD_start_volt, DMD_rampdown_start_time, DMD_rampdown_end_time, hor_DMD_power)
...
analogdata.AddSmoothRamp(quad_gravity_offset, 0, twodmax_ready_time, DMD_rampdown_end_time, ps1_ao)
...
analogdata.AddSmoothRamp(ps6_scaler*quic_gravity_offset + ps6_offset, 0, twodmax_ready_time, DMD_rampdown_end_time, ps6_ao)
'PS 7
...
digitaldata2.AddPulse(lattice2D765_ttl,twod_start_time-1, DMD_rampdown_end_time)
digitaldata2.AddPulse(lattice2D765_ttl2,twod_start_time-1,  DMD_rampdown_end_time)
digitaldata2.AddPulse(lattice2D765_shutter,twod_start_time-20, DMD_rampdown_end_time)
digitaldata2.AddPulse(lattice2D765_shutter2,twod_start_time-20, DMD_rampdown_end_time)
...
analogdata.AddStep(lattice1_max_volt, twodmax_ready_time, DMD_rampdown_end_time, lattice2D765_power)
analogdata.AddStep(lattice2_max_volt, twodmax_ready_time, DMD_rampdown_end_time, lattice2D765_power2)
