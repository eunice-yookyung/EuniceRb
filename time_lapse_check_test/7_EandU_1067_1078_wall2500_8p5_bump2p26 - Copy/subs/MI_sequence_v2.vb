Public Function AddMottInsulatorSequencev2(ByVal t_start As Double, _
    ...
    'v2: separates gravity offsets and lattice grad offsets
    '*********************************************************************************************************************************************************
    ...
    If MI_en = True Then
        ...
        analogdata.AddSmoothRamp(quad_gravity_offset, quad_latt_grad_offset, twod_start_time, twodmax_ready_time, ps1_ao)
        ...
        'PS 6
        analogdata.AddSmoothRamp(ps6_scaler*quic_axis_offset + ps6_offset, 0, dimple_ready_time, bfield_off_time, ps6_ao) 'Ramp down PS6
        analogdata.AddSmoothRamp(0, quic_gravity_offset, bfield_off_time, axial_start_time, ps6_ao)
        analogdata.AddStep(quic_gravity_offset, axial_start_time, twod_start_time, ps6_ao)
        analogdata.AddSmoothRamp(quic_gravity_offset, quic_latt_grad_offset, twod_start_time, twodmax_ready_time, ps6_ao)
        ...
        'coils: quad_latt_grad_offset, quic_latt_grad_offset
