Public Function AddMottInsulatorSequenceSFHold(ByVal t_start As Double, _
...
Dim twodmax_ready_time As Double = twod_hold_end_time + twod_chopped_rampup*((rampV2)/(rampV))
