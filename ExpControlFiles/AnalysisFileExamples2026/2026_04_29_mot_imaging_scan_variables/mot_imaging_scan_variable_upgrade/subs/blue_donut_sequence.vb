Public Function AddBlueDonutSequence(ByVal t_start As Double, _
...
'returns end time and final voltage for dipole
...
Dim twodmax_ready_time As Double = twod_start_time
...
analogdata.AddStep(dipole_voltage, dipole_ready_time, twodmax_ready_time, red_dipole_power)'calibration
...
End If
    ...
    Return {t_stop, end_dipole_voltage}
End Function
