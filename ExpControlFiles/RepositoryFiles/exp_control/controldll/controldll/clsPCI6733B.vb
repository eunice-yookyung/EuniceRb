...
'This class configures a NI PCI-6733 analog output card set as device "Dev2". 

Imports NationalInstruments.DAQmx
Imports System

Public Class Dev2_PCI6733
    Inherits Task
    ...
    Public Sub Configure()
        Me.AOChannels.CreateVoltageChannel("Dev2/ao0", "VoltageOut0", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao1", "VoltageOut1", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao2", "VoltageOut2", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao3", "VoltageOut3", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao4", "VoltageOut4", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao5", "VoltageOut5", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao6", "VoltageOut6", -10, 10, AOVoltageUnits.Volts)
        Me.AOChannels.CreateVoltageChannel("Dev2/ao7", "VoltageOut7", -10, 10, AOVoltageUnits.Volts)
    End Sub
