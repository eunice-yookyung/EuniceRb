...
Public Class AD9959Ev

    'AD9959Ev DDS board communicated through TCP-IP to Labview

    Private myClient As TcpClient
    Dim hostname As String = "192.168.1.135"
    Dim port As Integer = 123
    Public Sub SetCh0Ch1FreqDiff(ByVal FreqDiff As Integer)

        Dim Freq0 As Integer = 82000000
        Dim Freq1 As Integer = Freq0 + FreqDiff


        Dim Cmd As String = "0;" & Freq0.ToString() & ";1;" & Freq1.ToString() & vbNewLine & vbLf
    ...
    End Sub
    Public Sub SetDDSFreq(ByVal Freq As Integer, ByVal channel As Integer)

        Dim Cmd As String = "setfreq," & channel.ToString() & "," & Freq.ToString() & ";" & vbNewLine & vbLf
    ...
    End Sub
    Public Sub SetDDSSweep(ByVal channel As Integer, ByVal StartFreq As Integer, ByVal StopFreq As Integer, ByVal sweep_duration As Integer)

        Dim Cmd As String = "sweep," & channel.ToString() & "," & StartFreq.ToString() & "," & StopFreq.ToString() & "," & sweep_duration.ToString() & ";" & vbNewLine & vbLf
