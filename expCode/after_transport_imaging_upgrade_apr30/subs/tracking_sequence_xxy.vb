Public Function AddTrackingSequenceXXY(ByVal t_start As Double, _
    ...
    If tracking_en = True Then
	    ...
	    digitaldata2.AddPulse(round_DMD_shutter, IT-50, IT + 3*guppy_interval )
	    digitaldata2.AddPulse(line_DMD_shutter, IT-50, IT + 3*guppy_interval )
	    analogdata2.AddStep(DMD_track_power_line, IT -10, IT + guppy_interval,line_DMD_power)
	    analogdata2.AddStep(DMD_track_power_line, IT + guppy_interval, IT + 2*guppy_interval,line_DMD_power)
	    analogdata2.AddStep(DMD_track_power, IT + 2*guppy_interval, IT + 3*guppy_interval,line_DMD_power)
	    ...
	    digitaldata2.AddPulse(line_DMD_ttl, IT,IT+guppy_exposure)
	    ...
	    digitaldata2.AddPulse(line_DMD_ttl,IT+ guppy_interval,IT+ guppy_interval+guppy_exposure )
	    'trigger to switch pattern from elliptical to round
		digitaldata2.AddPulse(line_DMD_trigger, IT+ 2*guppy_interval - 0.5,IT+ 2*guppy_interval)'changes tracking to round
	    ...
	    digitaldata2.AddPulse(round_DMD_ttl, IT+ 2*guppy_interval,IT+ 2*guppy_interval+guppy_exposure)
