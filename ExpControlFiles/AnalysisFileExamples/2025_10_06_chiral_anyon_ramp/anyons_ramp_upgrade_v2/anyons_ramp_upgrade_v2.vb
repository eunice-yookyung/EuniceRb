...
quic_ramp_final_dur = 0
quic_grad_final_level = 0
hold_time_aux = 0
tof_floquet = 0
delay_shaking = 0
...
Dim splitting_ramp_dur As Double = 250
Dim lattice2_doublon_depth As Double = 15
Dim splitting_quic_start As Double = 6 '5.5
...
Dim delay_tracking As Double = 1000
...
'analogdata.AddStep(quad_latt_grad_offset, twodphysics_start_time, pinning_ready_time, ps1_ao)
'analogdata.AddStep(quic_latt_grad_offset, twodphysics_start_time, pinning_ready_time, ps6_ao)
