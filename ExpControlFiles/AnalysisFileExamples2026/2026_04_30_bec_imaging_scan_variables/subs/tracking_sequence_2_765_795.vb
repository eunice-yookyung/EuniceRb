Public Function AddTrackingSequence2_765_795(ByVal t_start As Double, _
    ...
    If tracking_en = True Then
        ...
        '795 turn on analog
        analogdata.AddStep(DMD_track_795_power,IT -10 , IT + 3*guppy_interval,lattice2D795_power)
...
'	    digitaldata.AddPulse(lattice2D795_ttl,IT,IT+guppy_exposure) '1
'	    digitaldata2.AddPulse(lattice2D765_ttl2,IT,IT+guppy_exposure)
        ...
        digitaldata.AddPulse(lattice2D795_ttl,IT+ guppy_interval,IT+ guppy_interval+guppy_exposure) '2
        ...
        digitaldata.AddPulse(lattice2D795_ttl,IT+ 2*guppy_interval,IT+ 2*guppy_interval+guppy_exposure) '3
