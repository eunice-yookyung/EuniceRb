Public Function AddMOTSequence(ByVal t_start As Double, _
    ...
    If MOT_en = True Then
        ...
        'digitaldata.AddPulse(repump_shutter, t_start, t_start + mot_load_time-8) '04/2026: Repump Shutter starts to close early
