...
Public Class frmGUI_interactive
    ...
    Public Sub LoadMacros()
        ...
        For Each foundMacro As String In My.Computer.FileSystem.GetFiles(gui.inter.rootpath + "macros", Microsoft.VisualBasic.FileIO.SearchOption.SearchTopLevelOnly, "*.txt")
            Dim ss As String()
