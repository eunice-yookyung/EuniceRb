Public Function AddMottInsulatorSequenceSFHoldEj(ByVal t_start As Double, _
...
analogdata2.AddSmoothRamp(0,quic_push*2.45, t_start, t_start + cigar_move_time, ps5_ao)
analogdata2.AddStep(quic_push*2.45, t_start+ cigar_move_time, dimple_ready_time, ps5_ao)
...
analogdata.AddSmoothRamp(0, black_coil_zed*2.5, t_start, t_start + cigar_move_time, ps7_ao)
analogdata.AddSmoothRamp(black_coil_zed*2.5, spherical_black_coil*2.5, t_start + cigar_move_time, vertical_move_end_time, ps7_ao)
analogdata.AddStep(spherical_black_coil*2.5, vertical_move_end_time, dimple_ready_time, ps7_ao)
...
'PS 5
analogdata2.AddSmoothRamp(quic_push*2.45,0,dimple_ready_time,bfield_off_time, ps5_ao)'Ramp down PS5
'PS 6
...
'PS 7
analogdata.AddSmoothRamp(spherical_black_coil*2.5,0,dimple_ready_time,bfield_off_time, ps7_ao)
'Siphon
