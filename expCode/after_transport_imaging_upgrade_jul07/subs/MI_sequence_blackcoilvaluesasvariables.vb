Public Function AddMottInsulatorSequenceWithBlackCoilValuesAsVariables(ByVal t_start As Double, _
...
'analogdata2.AddStep(biglattice_galvo_volt, cigar_move_end_time-1000, twodmax_ready_time,line_DMD_power)
...
digitaldata2.AddPulse(round_dimple_shutter, dimple_start_time-40, twod_start_time)
