Public Function AddMottInsulatorSequence(ByVal t_start As Double, _
...
analogdata.AddSmoothRamp(0 + ps6_offset, quic_gravity_offset, bfield_off_time, axial_start_time, ps6_ao)
analogdata.AddStep(quic_gravity_offset, axial_start_time, twodmax_ready_time,ps6_ao)
