...
if_blow_away_F2 = 1
if_repump12_imaging = 1
'=====Variables=====
molasses_time = new_molasses_time
compressed_mot_time = new_compressed_mot_time
optical_pumping_time = new_optical_pumping_time
'mot_detuning_molasses_time  = new_mot_detuning_molasses_time 
'rp_shutter_offset_time = new_rp_shutter_offset_time
...
Dim MOT_end_time As Double = t_start + mot_load_time - molasses_time - compressed_mot_time + mot_detuning_molasses_time
Dim IT As Double
