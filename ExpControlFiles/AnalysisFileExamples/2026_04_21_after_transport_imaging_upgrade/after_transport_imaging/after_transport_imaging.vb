...
''transport_end_time = transport_end_time '- 0.4 '2026/04/27 fixing hand over btw sequence
'***************************** Evaporation ************************************************
...
If compress = 1 Then
    ...
    'analogdata.AddSmoothRamp(0.2895, 0.585, _
     '   transport_end_time, transport_end_time + quad_rampup_time, ps3_ao) 'Ramps final transport(T13) to higher value to keep pace with quad rampup (11.58->23.4)
    'analogdata.AddStep(0.585, transport_end_time + quad_rampup_time, transport_end_time + quad_rampup_time + hold_time, ps3_ao)

    analogdata.AddSmoothRamp(1.415, 2.342*0.8, _
...
Dim ghetto_fix_start_time As Double = Me.AddAbsorptionImagingSequence(IT, cp, analogdata, analogdata2, digitaldata, digitaldata2, gpib, Hermes, dds, True)
...
Dim scope_trigger As Double = 0' Originally IT
digitaldata.AddPulse(64, scope_trigger, scope_trigger+50) 
