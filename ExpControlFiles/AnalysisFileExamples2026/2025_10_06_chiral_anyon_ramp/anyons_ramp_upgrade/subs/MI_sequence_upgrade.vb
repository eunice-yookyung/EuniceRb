Public Function AddMottInsulatorSequenceUpgrade(ByVal t_start As Double, _
...
digitaldata.AddPulse(mot_low_current, t_start, twodmax_ready_time) 'MOT Current Supply
digitaldata.AddPulse(ta_shutter, t_start, twodmax_ready_time) 'TA Shutter. starts to close early, so the shutter is closed ASAP after the blow away pulse.
digitaldata.AddPulse(repump_shutter, t_start, twodmax_ready_time) 'Repump Shutter
'======================================
...
' add magnetic field to compensate gradient from lattice beams along quad axis
'Dim dQuad As Double  = quad_compensate_lattice*lattice1_max/45 'compensate gradient proportional to lattice depth
'analogdata.AddStep(quad_gravity_offset,axial_start_time,twod_start_time,ps1_ao)
'analogdata.AddRamp(quad_gravity_offset, quad_gravity_offset+dQuad, twod_start_time, twodmax_ready_time, ps1_ao)
...
'Dim dQMirror As Double  = quic_mirror_compensate_lattice*lattice1_max/45 'compensate gradient proportional to lattice depth
'analogdata2.AddRamp(0,dQMirror*ps5_scaler,twod_start_time,twodmax_ready_time, ps5_ao)'compensate lattice gradient
...
' add magnetic field to compensate gradient from lattice beams along quic axis
'Dim dQuic As Double  = quic_compensate_lattice*lattice1_max/45 'compensate gradient proportional to lattice depth
'analogdata.AddStep(ps6_scaler*quic_gravity_offset + ps6_offset,axial_start_time,twod_start_time,ps6_ao)
'analogdata.AddRamp(ps6_scaler*quic_gravity_offset + ps6_offset, ps6_scaler*(quic_gravity_offset+dQuic) + ps6_offset, twod_start_time, twodmax_ready_time, ps6_ao)
