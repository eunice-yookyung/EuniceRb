...
Dim grad_onoff_dur As Double = 60
...
Dim Berlin_wall_expansion_volt As Double = 2.9 '3.05
...
'() turn off gradients
Dim grad_turnoff_start_time As Double = walls_turnoff_end_time 'turn off coils when is_return = 0
...
' Hold 2D2
analogdata.AddStep(lattice2_max_volt, line_load_end_time, lattice_lower_start_time, lattice2D765_power2) '2D2
...
'		analogdata.AddRampLogSine3Return(lattice2_low_depth, latticemod_amp_1, latticemod_amp_2, latticemod_amp_3, mod_freq_Hz_1, mod_freq_Hz_2, mod_freq_Hz_3, 
'										 phase_pi_final, mod_start_time, lattice_mod_ramp_dur, mod_hold_dur + phase_ramp_dur, lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
...
'									phase_pi_final, hold_start_time, hold_end_time, hold_start_time - mod_start_time, 
'									lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
'	End If
'Else
'	If (is_return > 0) Then
'		' ramp up and return
'		analogdata.AddRampLogSine3Return(lattice2_low_depth, latticemod_amp_1, latticemod_amp_2, latticemod_amp_3, mod_freq_Hz_1, mod_freq_Hz_2, mod_freq_Hz_3, 
'										 phase_pi_init, mod_start_time, lattice_mod_ramp_dur, mod_hold_dur, lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
'	Else
'		' ramp up
'		'analogdata.AddRampLogSine3NoReturn(lattice2_low_depth, latticemod_amp_1, latticemod_amp_2, latticemod_amp_3, mod_freq_Hz_1, mod_freq_Hz_2, mod_freq_Hz_3, phase_pi_init, mod_start_time, lattice_mod_ramp_dur, mod_hold_dur, lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
'		analogdata.AddRampLogSine3PhaseNoReturn(lattice2_low_depth, latticemod_amp_1, latticemod_amp_2, latticemod_amp_3, mod_freq_Hz_1, mod_freq_Hz_2, mod_freq_Hz_3, 
...
'												lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
'		analogdata.AddLogSine3Phase(lattice2_low_depth, latticemod_amp_1, latticemod_amp_2, latticemod_amp_3, mod_freq_Hz_1, mod_freq_Hz_2, mod_freq_Hz_3, 
'									phase_pi_final, hold_start_time, hold_end_time, phase_ramp_end_time - mod_start_time, 
'									lattice2_voltage_offset, lattice2_calib_volt, lattice2_calib_depth, lattice2D765_power2)
'	End If
'End If
...
analogdata.AddStep(lattice2_max_volt, lattice_raise_end_time, lattice_freeze_start_time, lattice2D765_power2)
...
' 2D delocalization
' PS 5 (quic)
Dim quic_grad_end As Double = 0
analogdata2.AddStep(0, twodphysics_start_time, grad_turnon_start_time, ps5_ao)
analogdata2.AddSmoothRamp(0, quic_grad_init*ps5_scaler, grad_turnon_start_time, grad_turnon_end_time, ps5_ao)
...
End If
analogdata2.AddStep(quic_grad_end, grad_raise_end_time, grad_turnoff_start_time, ps5_ao)
