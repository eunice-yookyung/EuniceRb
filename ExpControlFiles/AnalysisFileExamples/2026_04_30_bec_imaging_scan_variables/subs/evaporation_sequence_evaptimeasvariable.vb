Public Function AddEvaporationSequenceWithEvapTimeAsVariable(ByVal t_start As Double, _
    ...
    If evap_en = True Then
        ...
        analogdata.AddSmoothRamp(1.415, 2.342*.8, _
        ...
        analogdata.AddSmoothRamp(2.342*.8, 0, transport_end_time + quad_rampup_time, ioffe_ready_time, ps1_ao)'Ramp Down PS1
        ...
        analogdata.AddSmoothRamp(0.00417, 2.342*.8, transport_end_time + quad_rampup_time, ioffe_ready_time, ps2_ao) 'Ramp Up PS2
        ...
        analogdata.AddStep(2.342*.8, ioffe_ready_time, evaporation_end_time, ps2_ao) 'Holds cigar trap on during evaporation
