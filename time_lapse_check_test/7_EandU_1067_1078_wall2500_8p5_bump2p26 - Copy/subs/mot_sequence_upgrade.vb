Public Function AddMOTSequenceUpgrade(ByVal t_start As Double, _
	...
	'=======INVERT SIGNALS FOR UPGRADE=====
        ...
        'digitaldata.AddPulse(repump_shutter, t_start + mot_load_time , transport_start_time) 'Repump Shutter starts to close early
	'======================================
        ...
        digitaldata.AddPulse(ttl_N133MHz, t_start + mot_load_time, t_start + mot_load_time + optical_pumping_time) ' -133MHz TTL(2->2 AOM) 'HERE
        ...
        digitaldata.AddPulse(polarizer_shutter_11, t_start + mot_load_time - 60, t_start + mot_load_time + 30) 'Optical Pumping (1-1) Shutter 
        ...
        digitaldata.AddPulse(ttl_N133MHz, mot_load_time+blow_away_start_time, mot_load_time+blow_away_start_time+10) ' -133MHz TTL(2->2 AOM) 'HERE
