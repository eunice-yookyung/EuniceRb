Public Function AddMottInsulatorSequenceWithWalls(ByVal t_start As Double, _
    ByVal WallsInMI As Double, _ 
    ByVal MIWallsRampDur As Double, _
...
If WallsInMI = 1 Then
    twod_start_time = dipole_ready_time + dimple_ramp_down + MIWallsRampDur
End If 
