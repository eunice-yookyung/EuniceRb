Public Function AddTrackingSequenceUpgradeSplit(ByVal t_start As Double,
	...
	If tracking_en = True Then
		...
		analogdata.AddStep(DMD_track_765_power, IT - 10, IT + 2 * guppy_interval/2, lattice2D765_power)
		analogdata.AddStep(DMD_track_765_power2, IT - 10, IT + 2 * guppy_interval/2, lattice2D765_power2)
		analogdata2.AddStep(DMD_track_power_line, IT + 2 * guppy_interval - 10, IT + 3 * guppy_interval, line_DMD_power)
		analogdata2.AddStep(DMD_track_power_hor, IT + 2 * guppy_interval - 10, IT + 3 * guppy_interval, hor_DMD_power)

		digitaldata2.AddPulse(lattice2D765_shutter, IT - 50, IT + 2 * guppy_interval/2)
		digitaldata2.AddPulse(lattice2D765_shutter2, IT - 50, IT + 2 * guppy_interval/2)
		digitaldata2.AddPulse(line_DMD_shutter, IT + 2 * guppy_interval/2, IT + 3 * guppy_interval+1)
		digitaldata2.AddPulse(hor_DMD_shutter, IT + 2 * guppy_interval/2, IT + 3 * guppy_interval+1)
		...
		digitaldata2.AddPulse(round_DMD_ttl, IT + 2 * guppy_interval, IT + 2 * guppy_interval + guppy_dot_exposure)
