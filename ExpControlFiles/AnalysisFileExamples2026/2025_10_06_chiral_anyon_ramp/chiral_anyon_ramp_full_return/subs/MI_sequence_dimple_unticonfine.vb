Public Function AddMottInsulatorDimpleAnticonfineSequence(ByVal t_start As Double, _
...
Dim anticonfine_start_time As Double = axial_ready_time
Dim anticonfine_ready_time As Double = anticonfine_start_time + 10
Dim anticonfine_end_time As Double = anticonfine_ready_time + 10
Dim dipole_start_time As Double = anticonfine_end_time + big_lattice_rampdown	
...
analogdata.AddSmoothRamp(0,quic_push*2.45, t_start, t_start + cigar_move_time, ps5_ao)
analogdata.AddStep(quic_push*2.45, t_start+ cigar_move_time, dimple_ready_time, ps5_ao)
...
Dim a30hz_voltage As Double = red_calib_volt+Log10(30/red_calib_freq)
Dim a70hz_voltage As Double = red_calib_volt+Log10(red_freq/red_calib_freq)

Dim kink_time As Double = 225

analogdata.AddSmoothRamp(1.44, a20hz_voltage, dipole_start_time, dipole_ready_time, red_dipole_power)
analogdata.AddStep(a20hz_voltage, dipole_ready_time, twod_start_time, red_dipole_power) 'calibration
analogdata.AddLogRamp(a20hz_voltage, a70hz_voltage, twod_start_time, twod_start_time + kink_time, red_dipole_power)
analogdata.AddStep(a70hz_voltage, twod_start_time + kink_time, twod_start_time + kink_time + 1, red_dipole_power) 'calibration
analogdata.AddStep(dipole_voltage, twod_start_time + kink_time + 1, twodmax_ready_time, red_dipole_power) 'calibration

end_dipole_voltage = dipole_voltage

Dim anticonfine_dimple_volt As Double = 2.5
digitaldata.AddPulse(blue_dipole_shutter,anticonfine_start_time-20, anticonfine_end_time)
digitaldata2.AddPulse(blue_dipole_ttl,anticonfine_start_time,anticonfine_end_time)

analogdata.AddSmoothRamp(1, anticonfine_dimple_volt, anticonfine_start_time, anticonfine_ready_time, red_dipole_power)
'analogdata.AddStep(anticonfine_volt,expand_start_time1+ anticonfine_ramp_dur, lattice_reload_start_time1 - anticonfine_ramp_dur , red_dipole_power)
analogdata.AddSmoothRamp(anticonfine_dimple_volt,1,anticonfine_ready_time, anticonfine_end_time, red_dipole_power)
...
'PS 5
analogdata.AddSmoothRamp(quic_push*2.45,0,dimple_ready_time,bfield_off_time, ps5_ao)'Ramp down PS5
'PS 6
