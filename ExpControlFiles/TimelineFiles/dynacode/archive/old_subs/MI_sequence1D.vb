Public Function AddMottInsulatorSequence1D(ByVal t_start As Double, _
...
Dim twod_start_time1 As Double = dipole_ready_time + dimple_ramp_down
Dim twod_start_time2 As Double = twod_start_time1 + twod_chopped_rampup*2+bandgap_open_rampup*2
Dim twodmax_ready_time As Double = twod_start_time2 + twod_chopped_rampup*2+bandgap_open_rampup*2
...
analogdata.AddSmoothRamp(intermediate_axial_voltage,axial_voltage,dipole_ready_time,twod_start_time1,axial_lattice_power)
analogdata.AddStep(axial_voltage,twod_start_time1,twodmax_ready_time,axial_lattice_power)

'******************************************** beginning of dimple ramp on ****************************
digitaldata2.AddPulse(round_dimple_shutter, dimple_start_time-20,twod_start_time1)
digitaldata2.AddPulse(round_dimple_ttl, dimple_start_time-1,twod_start_time1)
...
analogdata2.AddSmoothRamp(round_dimple_voltage,1.7,dipole_ready_time,twod_start_time1, round_dimple_power)
'**********************************************Blue Doughnut******************************************
...
analogdata.AddStep(dipole_voltage,dipole_ready_time, twod_start_time1 + bandgap_open_rampup, red_dipole_power)'calibration
...
analogdata.AddRamp(dipole_voltage, end_dipole_voltage, twod_start_time1, twodmax_ready_time, red_dipole_power)
...
'PS 7
analogdata.AddSmoothRamp(black_coil_zed*2.5,0,dimple_ready_time,bfield_off_time, ps7_ao)
'Siphon
...
digitaldata2.AddPulse(lattice2D765_ttl,twod_start_time1-1, twodmax_ready_time)
digitaldata2.AddPulse(lattice2D765_ttl2,twod_start_time1-1,  twodmax_ready_time)
digitaldata2.AddPulse(lattice2D765_shutter,twod_start_time1-20, twodmax_ready_time)
digitaldata2.AddPulse(lattice2D765_shutter2,twod_start_time1-20, twodmax_ready_time)

analogdata.AddLogRamp(lattice1_start_volt,lattice1_midpoint_volt,twod_start_time1,twod_start_time1+bandgap_open_rampup*2,lattice2D765_power)
analogdata.AddLogRamp(lattice2_start_volt,lattice2_midpoint_volt,twod_start_time2,twod_start_time2+bandgap_open_rampup*2,lattice2D765_power2)
analogdata.AddRamp(lattice1_midpoint_volt,lattice1_max_volt,twod_start_time1+bandgap_open_rampup*2,twod_start_time2,lattice2D765_power)
analogdata.AddStep(lattice1_max_volt,twod_start_time2,twodmax_ready_time,lattice2D765_power)
analogdata.AddRamp(lattice2_midpoint_volt,lattice2_max_volt,twod_start_time2+bandgap_open_rampup*2,twodmax_ready_time,lattice2D765_power2)
