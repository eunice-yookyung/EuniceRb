Public Function AddEvaporationSequenceWithEvapTimeAsVariable(ByVal t_start As Double, _
    ...
    Dim quic_hold_time As Double = evap_time-quad_rampup_time-ioffe_creation_time
    ...
    If evap_en = True Then
        ...
        'CHANGE BACK HERE
        'analogdata.AddSmoothRamp(1.415, 2.342, _
        '    transport_end_time, transport_end_time + quad_rampup_time, ps1_ao) 'Ramps quadrupole from final transport value to quic value(33.96->56.208)
        analogdata.AddSmoothRamp(1.415, 2.342*quad_scalar, _
        ...
        analogdata.AddSmoothRamp(.2895, 0.585*1.0, _
        ...
        analogdata.AddSmoothRamp(0.585*1.0, 0.875, _
        ...
        Dim cigarwindup As Double = 1.35 '1.3 '1.9
        'CHANGE BACK HERE
        'analogdata.AddSmoothRamp(2.342, 0, transport_end_time + quad_rampup_time, ioffe_ready_time, ps1_ao)'Ramp Down PS1
        analogdata.AddSmoothRamp(2.342*quad_scalar, 0, transport_end_time + quad_rampup_time, ioffe_ready_time, ps1_ao)'Ramp Down PS1
        ...
        'CHANGE BACK HERE
        'analogdata.AddSmoothRamp(0.00417, 2.342, transport_end_time + quad_rampup_time, ioffe_ready_time, ps2_ao) 'Ramp Up PS2
        analogdata.AddSmoothRamp(0.00417, 2.342*quad_scalar, transport_end_time + quad_rampup_time, ioffe_ready_time, ps2_ao) 'Ramp Up PS2
        'digitaldata.AddPulse(ps2_shunt, transport_end_time + quad_rampup_time - 1000, transport_end_time + quad_rampup_time - 0.1) 'PS2 shunt
        ...
        'CHANGE BACK HERE
        'analogdata.AddStep(2.342, ioffe_ready_time, evaporation_end_time, ps2_ao) 'Holds cigar trap on during evaporation
        analogdata.AddStep(2.342*quad_scalar, ioffe_ready_time, evaporation_end_time, ps2_ao) 'Holds cigar trap on during evaporation

        'Stray current test 
        'digitaldata2.AddPulse(quad_shim2, transport_end_time, evaporation_end_time)
        'analogdata2.AddSmoothRamp(0, 0.1, transport_end_time, transport_end_time + 100, ps8_ao)
        'analogdata2.AddStep(0.1, transport_end_time + 100, evaporation_end_time - 100, ps8_ao)
        'analogdata2.AddSmoothRamp(0.1, 0, evaporation_end_time - 100, evaporation_end_time, ps8_ao)
