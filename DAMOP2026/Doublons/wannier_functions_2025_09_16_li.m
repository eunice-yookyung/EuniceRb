...
Vlat            = 100;
x               = linspace(-5,5,5e3)'; % x position in units of lattice spacing
...
for Vlat = 10:40
    ...
    % Calculate U
    Uintegral = (trapz(x, abs(wn).^4))^3 * 8/pi;
    U = Uintegral * a_s/a_lattice;
    E2 = E(3,:);
    E1 = E(2,:);
    E0 = E(1,:);
    Egap = min(E1) - max(E0);
    ...
    wannier_results = [wannier_results; table(Vlat, J, U, Uintegral, Egap, Egap2, x, wn)];
