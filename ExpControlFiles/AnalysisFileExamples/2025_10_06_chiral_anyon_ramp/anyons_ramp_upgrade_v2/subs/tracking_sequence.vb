Public Function AddTrackingSequence(ByVal t_start As Double, _
    ...
    If tracking_en = True Then
	    ...
	    analogdata2.AddStep(DMD_track_power, IT -10, IT + 3*guppy_interval, line_DMD_power)
	    ...
	    digitaldata2.AddPulse(round_DMD_ttl, IT,IT+guppy_dot_exposure)
	    ...
	    digitaldata2.AddPulse(round_DMD_ttl,IT+ guppy_interval,IT+ guppy_interval+guppy_dot_exposure )
