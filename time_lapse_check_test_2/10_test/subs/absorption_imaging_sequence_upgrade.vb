Public Function AddAbsorptionImagingSequenceUpgrade(ByVal t_start As Double,
    ...
    If absorption_en = True Then
        ...
        'digitaldata.AddPulse(probe_shutter, t_start - 10, t_start + imaging_time) 'imaging Shutter 'Updated 7/9/26
        ...
        digitaldata.AddPulse(ttl_78MHz, t_start - 40, t_start - 0.3)
